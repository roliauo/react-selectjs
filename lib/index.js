...
var Selector = function (_React$Component) {
	...
	_createClass(Selector, [{
		...
		value: function renderOption(name, option, index) {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'span',
					{ className: this.css("title"), style: { padding: this.props.padding } },
					option
				)
			);
		}
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: this.css("custom-select"), style: { width: width, 'borderRadius': borderRadius } },
				_react2.default.createElement('input', { type: 'radio', name: name, onClick: function onClick(e) {
						return _this3.toggleList(e);
					}, checked: this.state.open }),
				_react2.default.createElement(
					'span',
					{ className: this.css("placeholder"), style: { padding: padding } },
					title
				),
